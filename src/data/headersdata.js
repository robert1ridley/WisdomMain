const headers = {
  chinese: [
    ...
    {head: "决定方案", icon: "glyphicon glyphicon-pushpin", id: 4, link: "/plans/1"},
    {head: "工程业绩", icon: "glyphicon glyphicon-certificate", id: 5, link: "/achievements/1"},
    {head: "团队", icon: "glyphicon glyphicon-education", id: 6, link: "/careers/1"},
  ...
  english: [
    ...
    {head: "Plans", icon: "glyphicon glyphicon-pushpin", id: 4, link: "/plans/1"},
    {head: "Achievements", icon: "glyphicon glyphicon-certificate", id: 5, link: "/achievements/1"},
    {head: "Team", icon: "glyphicon glyphicon-education", id: 6, link: "/careers/1"},
