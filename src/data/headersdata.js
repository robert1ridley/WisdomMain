const headers = {
  chinese: [
    ...
    {head: "决定方案", icon: "glyphicon glyphicon-pushpin", id: 4, link: "/solutions/1"},
    {head: "工程业绩", icon: "glyphicon glyphicon-certificate", id: 5, link: "/achievements/oil-and-gas-recovery"},
    {head: "团队", icon: "glyphicon glyphicon-education", id: 6, link: "/careers/jobs"},
  ...
  english: [
    ...
    {head: "Solutions", icon: "glyphicon glyphicon-pushpin", id: 4, link: "/solutions/1"},
    {head: "Achievements", icon: "glyphicon glyphicon-certificate", id: 5, link: "/achievements/oil-and-gas-recovery"},
